...
### **General Usage** ###
  ...
  $ csi
  csi[v0.1.290]:001 » CSI.help
  csi[v0.1.290]:002 » CSI::Plugins.help
  csi[v0.1.290]:003 » CSI::WWW.help
  csi[v0.1.290]:004 » CSI::WWW::Google.help
  csi[v0.1.290]:005 » CSI::WWW::Google.open(:browser_type => :chrome)
  csi[v0.1.290]:006 » CSI::WWW::Google.search(:q => 'site:github.com')
  csi[v0.1.290]:007 » CSI::WWW::Google.search(:q => 'site:github.com inurl:"ninp0/csi"')
  csi[v0.1.290]:008 » CSI::WWW::Google.close
  ```
  ...
  ```
  csi[v0.1.290]:1 » CSI::Plugins::TransparentBrowser.help
    USAGE:
      ...

  csi[v0.1.290]:2 » CSI::Plugins::BurpSuite.help
    USAGE:
      ...

  csi[v0.1.290]:3 » CSI::Plugins::OwaspZapIt.help
    USAGE:
      ...
  ```
  ...
  ```
  # csi
  csi[v0.1.290]:1 » CSI::Plugins::NmapIt.help
  USAGE:
  ...
  => nil
  csi[v0.1.290]:2 » CSI::Plugins::NmapIt.port_scan do |nmap|
  csi[v0.1.290]:2 *   nmap.syn_scan = true
  csi[v0.1.290]:2 *   nmap.service_scan = true
  csi[v0.1.290]:2 *   nmap.os_fingerprint = true
  csi[v0.1.290]:2 *   nmap.ports = [1..1024,1337]
  csi[v0.1.290]:2 *   nmap.targets = '127.0.0.1'
  csi[v0.1.290]:2 * end  
