...
### **Install in VirtualBox (Recommended if Testing in an Air Gapped Network)** ###
  ...
  ```
  $ csi
  csi[v0.1.95]:001 » CSI.help
  csi[v0.1.95]:002 » CSI::Plugins.help
  csi[v0.1.95]:003 » CSI::WWW.help
  csi[v0.1.95]:004 » CSI::WWW::Google.help
  csi[v0.1.95]:005 » CSI::WWW::Google.open(:browser_type => :chrome)
  csi[v0.1.95]:006 » CSI::WWW::Google.search(:q => 'site:github.com')
  csi[v0.1.95]:007 » CSI::WWW::Google.close
  ```
  ...
  ```
  csi[v0.1.95]:001 » .tor &
  csi[v0.1.95]:002 » CSI::Plugin::TransparentBrowser.help
  csi[v0.1.95]:003 » b1 = CSI::Plugins::TransparentBrowser(:browser_type => :headless, :proxy => 'sock://127.0.0.1:9050')
  csi[v0.1.95]:004 » b1.goto("http://checkip.amazonaws.com")
  csi[v0.1.95]:004 » b 1= CSI::Plugins::TransparentBrowser.close(:browser_obj => b1)
  ```
  ...
  ```
  # csi
  csi[v0.1.95]:1 » CSI::Plugins::NmapIt.help
  USAGE:
  ...
  => nil
  csi[v0.1.95]:2 » CSI::Plugins::NmapIt.port_scan do |nmap|
  csi[v0.1.95]:2 *   nmap.syn_scan = true
  csi[v0.1.95]:2 *   nmap.service_scan = true
  csi[v0.1.95]:2 *   nmap.os_fingerprint = true
  csi[v0.1.95]:2 *   nmap.ports = [1..1024,1337]
  csi[v0.1.95]:2 *   nmap.targets = '127.0.0.1'
  csi[v0.1.95]:2 * end  
