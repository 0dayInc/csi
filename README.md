...
### **Install in VirtualBox (Recommended if Testing in an Air Gapped Network)** ###
 ...
 `$ cd /opt/csi && sudo ./install.sh virtualbox`
  ...
  ```
  $ csi
  csi[v0.1.64]:001 » CSI.help
  csi[v0.1.64]:002 » CSI::Plugins.help
  csi[v0.1.64]:003 » CSI::WWW.help
  csi[v0.1.64]:004 » CSI::WWW::Google.help
  csi[v0.1.64]:005 » CSI::WWW::Google.open(:browser_type => :chrome)
  csi[v0.1.64]:006 » CSI::WWW::Google.search(:q => 'site:github.com')
  csi[v0.1.64]:007 » $browser = CSI::Plugins::TransparentBrowser.close(:browser_obj => $browser)
  ```
