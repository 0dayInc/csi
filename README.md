...
### **General Usage** ###
  ...
  $ csi
  csi[v0.1.690]:001 » CSI.help
  csi[v0.1.690]:002 » CSI::Plugins.help
  csi[v0.1.690]:003 » CSI::WWW.help
  csi[v0.1.690]:004 » CSI::WWW::Google.help
  csi[v0.1.690]:005 » CSI::WWW::Google.open(:browser_type => :chrome)
  csi[v0.1.690]:006 » CSI::WWW::Google.search(:q => 'site:github.com')
  csi[v0.1.690]:007 » CSI::WWW::Google.search(:q => 'site:github.com inurl:"ninp0/csi"')
  csi[v0.1.690]:008 » CSI::WWW::Google.close
  ```
  ...
  ```
  csi[v0.1.690]:1 » CSI::Plugins::TransparentBrowser.help
    USAGE:
      ...

  csi[v0.1.690]:2 » CSI::Plugins::BurpSuite.help
    USAGE:
      ...

  csi[v0.1.690]:3 » CSI::Plugins::OwaspZat.help
    USAGE:
      ...
  ```
  ...
  ```
  # csi
  csi[v0.1.690]:1 » CSI::Plugins::NmapIt.help
  USAGE:
  ...
  => nil
  csi[v0.1.690]:2 » CSI::Plugins::NmapIt.port_scan do |nmap|
  csi[v0.1.690]:2 *   nmap.syn_scan = true
  csi[v0.1.690]:2 *   nmap.service_scan = true
  csi[v0.1.690]:2 *   nmap.os_fingerprint = true
  csi[v0.1.690]:2 *   nmap.ports = [1..1024,1337]
  csi[v0.1.690]:2 *   nmap.targets = '127.0.0.1'
  csi[v0.1.690]:2 * end  
...
![CSI](https://github.com/ninp0/csi/blob/master/documentation/CSI_Driver_Arch.png)
  ```
  $ csi
  csi[v0.1.690]:1 » CSI.help
  => [:AWS, :MSF, :Plugins, :Reports, :SCAPM, :VERSION, :WWW, :WebApp]

  csi[v0.1.690]:2 » CSI::AWS.help
  => [:ACM,
   :APIGateway,
  ...
  csi[v0.1.690]:3 » CSI::Plugins.help
  => [:Android,
   :AnsibleVault,
  ...
  csi[v0.1.690]:0.4 » CSI::SCAPM.help
  => [:AMQPConnectAsGuest,
   :AWS,
