...
### **Install in VirtualBox (Recommended if Testing in an Air Gapped Network)** ###
  ...
  ```
  $ csi
  csi[v0.1.129]:001 » CSI.help
  csi[v0.1.129]:002 » CSI::Plugins.help
  csi[v0.1.129]:003 » CSI::WWW.help
  csi[v0.1.129]:004 » CSI::WWW::Google.help
  csi[v0.1.129]:005 » CSI::WWW::Google.open(:browser_type => :chrome)
  csi[v0.1.129]:006 » CSI::WWW::Google.search(:q => 'site:github.com')
  csi[v0.1.129]:007 » CSI::WWW::Google.search(:q => 'site:github.com inurl:"ninp0/csi"')
  csi[v0.1.129]:008 » CSI::WWW::Google.close
  ```
  
  You say you want to write post-authentication security tests for your own website?  That's cool friend, here's how:
  
  ```
  csi[v0.1.129]:1 » CSI::Plugins::TransparentBrowser.help
  USAGE:
  ...
  ```
  # csi
  csi[v0.1.129]:1 » CSI::Plugins::NmapIt.help
  USAGE:
  ...
  => nil
  csi[v0.1.129]:2 » CSI::Plugins::NmapIt.port_scan do |nmap|
  csi[v0.1.129]:2 *   nmap.syn_scan = true
  csi[v0.1.129]:2 *   nmap.service_scan = true
  csi[v0.1.129]:2 *   nmap.os_fingerprint = true
  csi[v0.1.129]:2 *   nmap.ports = [1..1024,1337]
  csi[v0.1.129]:2 *   nmap.targets = '127.0.0.1'
  csi[v0.1.129]:2 * end  
