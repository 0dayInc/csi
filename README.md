...
```
csi[v0.2.138]:001 >>> CSI::AWS::Rekognition.help
USAGE:
...
### **General Usage** ###
  ...
  $ csi
  csi[v0.2.138]:001 >>> CSI.help
  csi[v0.2.138]:002 >>> CSI::Plugins.help
  csi[v0.2.138]:003 >>> CSI::WWW.help
  csi[v0.2.138]:004 >>> CSI::WWW::Google.help
  csi[v0.2.138]:005 >>> CSI::WWW::Google.open(:browser_type => :chrome)
  csi[v0.2.138]:006 >>> CSI::WWW::Google.search(:q => 'site:github.com')
  csi[v0.2.138]:007 >>> CSI::WWW::Google.search(:q => 'site:github.com inurl:"ninp0/csi"')
  csi[v0.2.138]:008 >>> CSI::WWW::Google.close
  ```
  ...
  ```
  csi[v0.2.138]:001 >>> CSI::Plugins::TransparentBrowser.help
    USAGE:
      ...

  csi[v0.2.138]:002 >>> CSI::Plugins::BurpSuite.help
    USAGE:
      ...

  csi[v0.2.138]:003 >>> CSI::Plugins::OwaspZap.help
    USAGE:
      ...
  ```
  ...
  ```
  # csi
  csi[v0.2.138]:001 >>> CSI::Plugins::NmapIt.help
  USAGE:
  ...
  => nil
  csi[v0.2.138]:002 >>> CSI::Plugins::NmapIt.port_scan do |nmap|
  csi[v0.2.138]:003 ***   nmap.syn_scan = true
  csi[v0.2.138]:004 ***   nmap.service_scan = true
  csi[v0.2.138]:005 ***   nmap.os_fingerprint = true
  csi[v0.2.138]:006 ***   nmap.ports = [1..1024,1337]
  csi[v0.2.138]:007 ***   nmap.targets = '127.0.0.1'
  csi[v0.2.138]:008 *** end  
...
![CSI](https://github.com/ninp0/csi/blob/master/documentation/CSI_Driver_Arch.png)
  ```
  $ csi
  csi[v0.2.138]:002 >>> CSI.help
  => [:AWS, :MSF, :Plugins, :Reports, :SCAPM, :VERSION, :WWW, :WebApp]

  csi[v0.2.138]:003 >>> CSI::AWS.help
  => [:ACM,
   :APIGateway,
   :AppStream,
  ...
  csi[v0.2.138]:004 >>> CSI::Plugins.help
  => [:Android,
   :AnsibleVault,
  ...
  csi[v0.2.138]:005 >>> CSI::SCAPM.help
  => [:AMQPConnectAsGuest,
   :AWS,
