...
### **CSI Installation Dependencies** ###
  ...
  - Locally on your Box as a Ruby Gem
    ...
    * postgresql dev libraries
      * Ubuntu 16.04: `$ sudo apt-get install postgresql-server-dev-all`
      * OSX: `$ sudo port install postgresql96-server`

    * libpcap dev libraries
      * Ubuntu 16.04: `$ sudo apt-get install libpcap-dev`
      * OSX: `$ sudo port install libpcap`

    * ImageMagick 
      * Ubuntu 16.04: `$ sudo apt-get install libmagickwand-dev imagemagick`
      * OSX: `$ sudo port install imagemagick`

    * Tesseract (OCR) ;)
      * Ubuntu 16.04: `$ sudo apt-get install tesseract-ocr-all`
...
### **General Usage** ###
  ...
  $ csi
  csi[v0.1.745]:001 >>> CSI.help
  csi[v0.1.745]:002 >>> CSI::Plugins.help
  csi[v0.1.745]:003 >>> CSI::WWW.help
  csi[v0.1.745]:004 >>> CSI::WWW::Google.help
  csi[v0.1.745]:005 >>> CSI::WWW::Google.open(:browser_type => :chrome)
  csi[v0.1.745]:006 >>> CSI::WWW::Google.search(:q => 'site:github.com')
  csi[v0.1.745]:007 >>> CSI::WWW::Google.search(:q => 'site:github.com inurl:"ninp0/csi"')
  csi[v0.1.745]:008 >>> CSI::WWW::Google.close
  ```
  ...
  ```
  csi[v0.1.745]:001 >>> CSI::Plugins::TransparentBrowser.help
    USAGE:
      ...

  csi[v0.1.745]:002 >>> CSI::Plugins::BurpSuite.help
    USAGE:
      ...

  csi[v0.1.745]:003 >>> CSI::Plugins::OwaspZap.help
    USAGE:
      ...
  ```
  ...
  ```
  # csi
  csi[v0.1.745]:001 >>> CSI::Plugins::NmapIt.help
  USAGE:
  ...
  => nil
  csi[v0.1.745]:002 >>> CSI::Plugins::NmapIt.port_scan do |nmap|
  csi[v0.1.745]:003 ***   nmap.syn_scan = true
  csi[v0.1.745]:004 ***   nmap.service_scan = true
  csi[v0.1.745]:005 ***   nmap.os_fingerprint = true
  csi[v0.1.745]:006 ***   nmap.ports = [1..1024,1337]
  csi[v0.1.745]:007 ***   nmap.targets = '127.0.0.1'
  csi[v0.1.745]:008 *** end  
...
![CSI](https://github.com/ninp0/csi/blob/master/documentation/CSI_Driver_Arch.png)
  ...
  csi[v0.1.745]:003 >>> CSI::Plugins.help
  => [:Android,
   :AnsibleVault,
  ...
  csi[v0.1.745]:004 >>> CSI::SCAPM.help
  => [:AMQPConnectAsGuest,
   :AWS,
