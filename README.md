...
### **General Usage** ###
  ...
  $ csi
  csi[v0.1.166]:001 » CSI.help
  csi[v0.1.166]:002 » CSI::Plugins.help
  csi[v0.1.166]:003 » CSI::WWW.help
  csi[v0.1.166]:004 » CSI::WWW::Google.help
  csi[v0.1.166]:005 » CSI::WWW::Google.open(:browser_type => :chrome)
  csi[v0.1.166]:006 » CSI::WWW::Google.search(:q => 'site:github.com')
  csi[v0.1.166]:007 » CSI::WWW::Google.search(:q => 'site:github.com inurl:"ninp0/csi"')
  csi[v0.1.166]:008 » CSI::WWW::Google.close
  ```
  ...
  ```
  csi[v0.1.166]:1 » CSI::Plugins::TransparentBrowser.help
    USAGE:
      ...

  csi[v0.1.166]:2 » CSI::Plugins::BurpSuite.help
    USAGE:
      ...

  csi[v0.1.166]:3 » CSI::Plugins::OwaspZapIt.help
    USAGE:
      ...
  ```
  ...
  ```
  # csi
  csi[v0.1.166]:1 » CSI::Plugins::NmapIt.help
  USAGE:
  ...
  => nil
  csi[v0.1.166]:2 » CSI::Plugins::NmapIt.port_scan do |nmap|
  csi[v0.1.166]:2 *   nmap.syn_scan = true
  csi[v0.1.166]:2 *   nmap.service_scan = true
  csi[v0.1.166]:2 *   nmap.os_fingerprint = true
  csi[v0.1.166]:2 *   nmap.ports = [1..1024,1337]
  csi[v0.1.166]:2 *   nmap.targets = '127.0.0.1'
  csi[v0.1.166]:2 * end  
...
### **CSI Modules Can be Mixed and Matched to Produce Your Own Drivers** ###
  ...
  csi[v0.1.166]:3 » CSI::WWW.help
  => [:Bing, :Checkip, :Duckduckgo, :Google, :Hackerone, :Pastebin, :Synack, :Torch, :Youtube]
  ```



  I hope you enjoy CSI and remember...be sure to always get permission prior to carrying out any sort of automated hacktivities.  Cheers!
