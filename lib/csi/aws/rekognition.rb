    ...
    module Rekognition
      ...
      def self.connect(opts = {})
        ...
        if sts_session_token == ''
          rekognition_obj = Aws::Rekognition::Client.new(
            region: region,
      ...
      def self.disconnect(opts = {})
        rekognition_obj = opts[:rekognition_obj]
