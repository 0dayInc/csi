  ...
  module Plugins
    ...
    module AWSKMS
      ...
      def self.connect(opts = {})
        ...
        begin
          @@logger.info("Connecting to AWS KMS...")
          if sts_session_token == ""
            kms_obj = Aws::KMS::Client.new(
              :region => region,
