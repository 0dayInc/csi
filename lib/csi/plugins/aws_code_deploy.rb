...
module CSI
  module Plugins
    ...
    module AWSCodeDeploy
      ...
      # CSI::Plugins::AWSCodeDeploy.connect(
      ...
      def self.connect(opts = {})
        ...
        begin
          @@logger.info("Connecting to AWS CodeDeploy...")
          if sts_session_token == ""
            code_deploy_obj = Aws::CodeDeploy::Client.new(
              :region => region,
