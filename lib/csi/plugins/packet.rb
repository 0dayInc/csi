...
module CSI
  module Plugins
    ...
    module Packet
      ...
      # Supported Method Parameters::
      # pkt = CSI::Plugins::Packet.construct_arp(
      ...
      # Supported Method Parameters::
      # pkt = CSI::Plugins::Packet.construct_hsrp(
      #   ip_saddr: 'required - source ip of packet',
      #   ip_daddr: 'required - destination ip to send packet',
      #   payload: 'optional - packet payload defaults to empty string',
      #   ip_id: 'optional - defaults to 0xfeed',
      ...
      # Supported Method Parameters::
      # pkt = CSI::Plugins::Packet.construct_icmpv6(
      #   ip_saddr: 'required - source ip of packet',
      #   ip_daddr: 'required - destination ip to send packet',
      #   payload: 'optional - packet payload defaults to empty string',
      #   ip_id: 'optional - defaults to 0xfeed',
      ...
      # Supported Method Parameters::
      # pkt = CSI::Plugins::Packet.construct_ip(
      #   ip_saddr: 'required - source ip of packet',
      #   ip_daddr: 'required - destination ip to send packet',
      #   payload: 'optional - packet payload defaults to empty string',
      #   ip_id: 'optional - defaults to 0xfeed',
      ...
      # Supported Method Parameters::
      # pkt = CSI::Plugins::Packet.construct_tcp(
      #   ip_saddr: 'required - source ip of packet',
      #   ip_daddr: 'required - destination ip to send packet',
      #   payload: 'optional - packet payload defaults to empty string',
      #   ip_id: 'optional - defaults to 0xfeed',
      ...
      def self.construct_tcp(opts = {})
        ...
        pkt.tcp_ecn = tcp_ecn
        pkt.tcp_flags = tcp_flags if tcp_flags
        pkt.tcp_win = tcp_win
        pkt.tcp_sum = tcp_sum
        pkt.tcp_urg = tcp_urg
      ...
      # Supported Method Parameters::
      # pkt = CSI::Plugins::Packet.construct_udp(
      #   ip_saddr: 'required - source ip of packet',
      #   ip_daddr: 'required - destination ip to send packet',
      #   payload: 'optional - packet payload defaults to empty string',
      #   ip_id: 'optional - defaults to 0xfeed',
