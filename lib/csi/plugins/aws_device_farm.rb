...
module CSI
  module Plugins
    ...
    module AWSDeviceFarm
      ...
      # CSI::Plugins::AWSDeviceFarm.connect(
      ...
      def self.connect(opts = {})
        ...
        begin
          @@logger.info("Connecting to AWS DeviceFarm...")
          if sts_session_token == ""
            device_farm_obj = Aws::DeviceFarm::Client.new(
              :region => region,
