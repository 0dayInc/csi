...
module CSI
  module Plugins
    ...
    module AWSCloudWatchEvents
      @@logger = CSI::Plugins::CSILogger.create()

      # Supported Method Parameters::
      # CSI::Plugins::AWSCloudWatchEvents.connect(
      ...
      def self.connect(opts = {})
        ...
        begin
          @@logger.info("Connecting to AWS CloudWatchEvents...")
          if sts_session_token == ""
            cloud_watch_events_obj = Aws::CloudWatchEvents::Client.new(
              :region => region,
      ...
      # Supported Method Parameters::
      # CSI::Plugins::AWSCloudWatchEvents.disconnect(
