    ...
    module ApacheFileSystemUtilAPI
      ...
      public_class_method def self.nist_800_53_requirements
        nist_800_53_requirements = {
          ...
          nist_800_53_uri: 'https://web.nvd.nist.gov/view/800-53/Rev4/control?controlName=SI-10'
        }
        nist_800_53_requirements
      end
      ...
      public_class_method def self.help
        puts "USAGE:
          apache_file_system_util_api_arr = #{self}.scan(
            :dir_path => 'optional path to dir defaults to .',
            :git_repo_root_uri => 'optional http uri of git repo scanned'
          )
