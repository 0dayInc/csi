...
module CSI
  module WWW
    ...
    module Youtube
      ...
      # browser_obj = CSI::WWW::Youtube.open(
      ...
      public_class_method def self.search(opts = {})
        ...
        browser_obj.text_field(name: 'search_query').wait_until_present.set(q)
        browser_obj.button(id: 'search-btn').wait_until_present.click
      ...
      # Supported Method Parameters::
      # browser_obj = CSI::WWW::Youtube.close(
      #   browser_obj: 'required - browser_obj returned from #open method'
      # )
