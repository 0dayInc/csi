...
new_user=`ruby -e "require 'yaml'; print YAML.load_file('/csi/etc/jenkins/jenkins_admin_user.yaml')['user']"`
new_pass=`ruby -e "require 'yaml'; print YAML.load_file('/csi/etc/jenkins/jenkins_admin_user.yaml')['pass']"`
