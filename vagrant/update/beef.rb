...
puts `sudo bash --login -c "source /etc/profile.d/rvm.sh; rvm install ruby-#{beef_ruby_version}; rvm use ruby-#{beef_ruby_version}; rvm gemset create #{beef_gemset}; cd #{beef_root}; gem install bundler; bundle install"`
puts "complete."
