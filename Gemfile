...
gem 'activesupport', '5.2.2'           # Required to properly build csi via rake w/in ruby-2.3.0 ***2019-01-08
gem 'anemone', '0.7.2'                 # Spider webpagesa ***2017-03-30
gem 'authy', '2.7.4'                   # MFA API Access into Authy service ***2019-10-08
gem 'aws-sdk', '3.0.1'                 # Amazon AWS SDK ***2017-12-18
gem 'bettercap', '1.6.2'               # MITM framework ***2017-12-18
gem 'brakeman', '4.3.1'                # Rails Security Scanner ***2019-01-08
...
gem 'nokogiri', '1.10.0'               # Parse HTML & XML Documents ***2019-01-08
...
gem 'pdf-reader', '2.2.0'              # Parsing PDF Reports ***2019-01-08
gem 'pg', '1.1.3'                      # Required Postgres Gem for Postgres Data Access Object ***2019-01-08
...
gem 'rbvmomi', '2.0.0'                 # Required for VMware-Fu ***2019-01-08
...
gem 'rtesseract', '3.0.2'              # Gem for image ocr (e.g. decoding captchas) ***2019-01-08
...
gem 'ruby-saml', '1.9.0'               # Support client-side SAML Authorization & Configuring w/ existing IDPs (e.g. OneLogin) ***2019-01-08
...
gem 'slack-ruby-client', '0.13.1'      # Used for interacting w/ Slack via bots ***2019-01-08
