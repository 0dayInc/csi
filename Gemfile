...
gem 'activesupport', '5.1.3'           # Required to properly build csi via rake w/in ruby-2.3.0 ***2017-08-20
gem 'anemone', '0.7.2'                 # Spider webpagesa ***2017-03-30
gem 'authy', '2.7.1'                   # MFA API Access into Authy service ***2017-02-13
gem 'aws-sdk', '2.10.29'               # Amazon AWS SDK ***2017-08-20
gem 'bettercap', '1.6.1'               # MITM framework ***2017-08-20
gem 'brakeman', '3.7.2'                # Rails Security Scanner ***2017-08-20
...
gem 'bunny', '2.7.0'                   # RabbitMQ ***2017-08-20
...
gem 'nexpose', '6.1.1'                 # Vuln Scan all the Things! ***2017-08-20
...
gem 'rex', '2.0.11'                    # Rex provides a variety of classes useful for security testing and exploit development ***2017-08-20
...
gem 'ruby-saml', '1.4.3'               # Support client-side SAML Authorization & Configuring w/ existing IDPs (e.g. OneLogin) ***2017-08-20
...
gem 'slack-ruby-client', '0.9.0'       # Used for interacting w/ Slack via bots ***2017-08-20
...
gem 'watir', '6.10.0'                   # Drive Various Web Browsers (IE, Chrome, Firefox, headless) ***2017-12-04
