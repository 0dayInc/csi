...
gem 'activesupport', '5.1.4'           # Required to properly build csi via rake w/in ruby-2.3.0 ***2017-12-18
...
gem 'brakeman', '4.1.0'                # Rails Security Scanner ***2017-12-18
gem 'bson', '4.2.2'                    # Required for mongo gem installation see https://api.mongodb.org/ruby/1.10.2/ ***2017-08-20
gem 'bundler-audit', '0.6.0'           # Checks for vulnerable versions of gems ***2017-08-20
gem 'bunny', '2.8.0'                   # RabbitMQ ***2017-12-18
...
gem 'jsonpath', '0.8.10'               # XPath-ify Complex JSON Data Structures ***2017-12-18
...
gem 'ruby-saml', '1.6.0'               # Support client-side SAML Authorization & Configuring w/ existing IDPs (e.g. OneLogin) ***2017-12-18
...
gem 'sinatra', '2.0.0'                 # Used for Phishing & Attacker Proof-of-Concept Demonstrations ***2017-08-20
gem 'slack-ruby-client', '0.11.0'      # Used for interacting w/ Slack via bots ***2017-12-18
...
gem 'watir', '6.10.2'                  # Drive Various Web Browsers (IE, Chrome, Firefox, headless) ***2017-12-18
